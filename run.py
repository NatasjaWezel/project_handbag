...
from rotation_helpers import rotate_fragment
...
def perform_rotations(fragment, atoms_to_put_in_plane, plot, bonds):
    ...
    if plot:
        plot_fragments(fragments_to_plot, labels=labels, bonds=bonds)
