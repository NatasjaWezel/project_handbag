...
from constants.paths import WORKDIR, RADII_CSV, METHYL_CSV
...
def main():
    ...
    if avg_frag_settings.central_group_name == "RCOMe" or avg_frag_settings.central_group_name == "REt":
        fragment = add_model_methyl(CSV=METHYL_CSV, fragment=fragment,
