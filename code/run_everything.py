    ...
    for central_group in central_groups[:1]:
        for to_count_contact, contact_group in zip(to_count, contact_groups):
            ...
            for resolution in resolutions:
                ...
                os.system("python 4_calc_density.py " + result1 + " " + str(round(resolution, 2)) + " " + to_count_contact)

                os.system("python 5_analyze_density.py " + result1 + " " + str(round(resolution, 2)) + " " + to_count_contact)
