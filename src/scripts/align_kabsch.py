...
def prepare_data(settings, data):
    ...
    # TODO: decide if you want to give the posibility of ignoring atoms during alignment
    # Then you would have to also add them again later.
